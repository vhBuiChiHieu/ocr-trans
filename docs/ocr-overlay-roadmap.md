...
- [ ] Cài PaddleOCR cho runtime CPU ổn định
- [ ] Kiểm tra app chạy ổn định trên CPU với bộ ảnh mẫu thực tế
...
- [ ] Preload OCR engine trên CPU khi app khởi động
- [ ] Nhận ảnh crop và trả ra text + confidence
- [ ] Log rõ runtime CPU đang hoạt động
...
- App không crash nếu OCR fail trên CPU runtime
